...
public class CreateContactWithOrganizationTest {
	public static void main(String[] args) {
		...
		String expectedContactSName = excelUtility.getDataFromExcel(2,1,"dock1")+randomNumber;
		...
		driver.findElement(By.xpath("//input[@name='lastname']")).sendKeys(expectedContactSName);
		...
		String etitle=expectedContactSName;
		String atitle=driver.findElement(By.xpath("//span[@id='dtlview_Last Name']")).getText();
